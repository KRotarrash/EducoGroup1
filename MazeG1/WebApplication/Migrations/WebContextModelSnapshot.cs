...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.BuildingTypeSafetyAssessment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("NameOfTypeSafetyAssessment")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("BuildingTypeSafetyAssessment");
                });

            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.FireInspectionBuilding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("BuildingAdressId")
                        .HasColumnType("bigint");

                    b.Property<long?>("BuildingTypeSafetyAssessmentId")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("DateInspection")
                        .HasColumnType("datetime2");

                    b.Property<long>("SpecialUserFireInspectionId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("BuildingAdressId");

                    b.HasIndex("BuildingTypeSafetyAssessmentId");

                    b.HasIndex("SpecialUserFireInspectionId")
                        .IsUnique();

                    b.ToTable("FireInspectionBuilding");
                });

            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.FireInspectionSchedule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("DateInspectionSchedule")
                        .HasColumnType("datetime2");

                    b.Property<int>("FireInspectionPeriodicity")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FireInspectionSchedule");
                });

            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.SpecialUserFireInspection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("SpecialUserFireInspection");
                });
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Job.Office", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.FireInspectionBuilding", b =>
                {
                    b.HasOne("WebApplication.DbStuff.Model.Adress", "BuildingAdress")
                        .WithMany("FireInspectionBuilding")
                        .HasForeignKey("BuildingAdressId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebApplication.DbStuff.Model.Firefighters.BuildingTypeSafetyAssessment", "BuildingTypeSafetyAssessment")
                        .WithMany("FireInspectionsBuilding")
                        .HasForeignKey("BuildingTypeSafetyAssessmentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebApplication.DbStuff.Model.Firefighters.SpecialUserFireInspection", "PerformedFireInspectionBuildingByUser")
                        .WithOne("FireInspectionBuilding")
                        .HasForeignKey("WebApplication.DbStuff.Model.Firefighters.FireInspectionBuilding", "SpecialUserFireInspectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.FireInspectionSchedule", b =>
                {
                    b.HasOne("WebApplication.DbStuff.Model.Adress", "BuildingAdress")
                        .WithOne("FireInspectionSchedule")
                        .HasForeignKey("WebApplication.DbStuff.Model.Firefighters.FireInspectionSchedule", "BuildingAdressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Firefighters.SpecialUserFireInspection", b =>
                {
                    b.HasOne("WebApplication.DbStuff.Model.SpecialUser", "User")
                        .WithMany("PerformedFireInspectionsBuilding")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("WebApplication.DbStuff.Model.Job.Position", b =>
                {
                    b.HasOne("WebApplication.DbStuff.Model.Job.Office", "Office")
                        .WithMany("Positions")
